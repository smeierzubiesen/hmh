        ...
        if (GetFileSizeEx(Filehandle, &Filesize)) {
            ...
            if (Result.Content) {
                ...
                if (ReadFile(Filehandle, Result.Content, FileSize32, &BytesRead, 0) &&
                    ...
                    //NOTE(smzb): File successfully read
...
/// <see cref="DIRECT_SOUND_CREATE"/>
internal void
PrintDebugTime(real64 ms, real64 fps, real64 MCyclesPerFrame) {
    char Buffer[256];
...
/// <returns>void</returns>
internal void
Win32FillSoundBuffer(win32_sound_output *SoundOutput, game_sound_buffer *SourceBuffer, DWORD ByteToLock, DWORD BytesToWrite) {
    VOID *Region1;
    DWORD Region1Size;
    VOID *Region2;
    DWORD Region2Size;
...
Win32MainWindowCallback(HWND Window, UINT Message, WPARAM WParam, LPARAM LParam)
{
    ...
    switch (Message) {
        ...
        case WM_KEYDOWN:
        {
            Assert(!"We received Keyboard input from a non-dispatch message! (this is BAD)");
        } break;
        case WM_SIZE:
        {
            // Do something
...
internal void
Win32ProcessKeyboardEvent(game_button_state *NewState, bool32 IsDown) {
    NewState->EndedDown = IsDown;
    ++NewState->HalfTransitionCount;
}

internal void
Win32ProcessXInputButton(DWORD XInputButtonState, game_button_state *OldState, game_button_state *NewState, DWORD ButtonBit) {
...
int CALLBACK
WinMain(HINSTANCE Instance, HINSTANCE hPrevInstance, LPSTR CommandLine, int ShowCode) 
{
